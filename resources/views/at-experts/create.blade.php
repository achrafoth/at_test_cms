        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('at-experts.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="expertise_area" class="block text-sm font-medium text-gray-700">Expertise Area</label>
                            <input type="text" name="expertise_area" id="expertise_area" value="{{ old('expertise_area') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">

                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('loans.update', $loan) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="at_equipment_id" name="at_equipment_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                ...
                                @foreach($equipment as $item)
                                    <option value="{{ $item->id }}" {{ old('at_equipment_id', $loan->at_equipment_id) == $item->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="expected_return_date" class="block mt-1 w-full" type="date" name="expected_return_date" :value="old('expected_return_date', $loan->expected_return_date->format('Y-m-d'))" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="actual_return_date" class="block mt-1 w-full" type="date" name="actual_return_date" :value="old('actual_return_date', $loan->actual_return_date ? $loan->actual_return_date->format('Y-m-d') : '')" />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status" name="status" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="on_loan" {{ old('status', $loan->status) == 'on_loan' ? 'selected' : '' }}>On Loan</option>
                                <option value="returned" {{ old('status', $loan->status) == 'returned' ? 'selected' : '' }}>Returned</option>
                                <option value="lost" {{ old('status', $loan->status) == 'lost' ? 'selected' : '' }}>Lost</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="notes" name="notes" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('notes', $loan->notes) }}</textarea>

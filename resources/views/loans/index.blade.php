<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('loans.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                {{ __('Add New Loan') }}
            </a>
        </div>
    </x-slot>
                            ...
                            <table class="min-w-full bg-white border border-gray-200">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Equipment</th>
                                        ...
                                        <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Expected Return</th>
                                    ...
                                    @foreach ($loans as $loan)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium">
                                                <a href="{{ route('loans.show', $loan) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                                                <a href="{{ route('loans.edit', $loan) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">Edit</a>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-700">
                                        No equipment loans found. Click "Add New Loan" to create one.
                                    </p>
                                </div>
                            </div>
                        </div>

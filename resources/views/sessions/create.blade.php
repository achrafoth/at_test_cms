                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('sessions.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="trusted_specialist_id" id="trusted_specialist_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                @foreach($specialists as $specialist)
                                    <option value="{{ $specialist->id }}" {{ old('trusted_specialist_id') == $specialist->id ? 'selected' : '' }}>
                                        {{ $specialist->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="at_expert_id" id="at_expert_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                @foreach($experts as $expert)
                                    <option value="{{ $expert->id }}" {{ old('at_expert_id') == $expert->id ? 'selected' : '' }}>
                                        {{ $expert->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="session_date" id="session_date" value="{{ old('session_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('session_date')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="session_duration" id="session_duration" value="{{ old('session_duration') }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="outcome" id="outcome" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('outcome') }}</textarea>
                            @error('outcome')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
